...
* *Relative Trace Formula and twisted L-functions: the Burgess Bound*. (2023). 46 pages. \[[arxiv](https://arxiv.org/pdf/2305.10719.pdf)\]


* *Relative Trace Formula and L-functions for GL(n+1)$$\times$$GL(n)*. (2023). 80 pages. \[[arxiv](https://arxiv.org/pdf/2303.02225.pdf)\]
...
* *A Coarse Jacquet-Zagier Trace Formula for GL(n) with Applications*. Preprint. (2021), 67 pages.\[[pdf](https://drive.google.com/file/d/1WYRQDpVpH0b3jrwCwMBHlszqpxXOeQVw/view?usp=sharing)\]
